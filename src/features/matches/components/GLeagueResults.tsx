...
import GLeagueResultsSkeleton from '@/features/matches/components/GLeagueResultsSkeleton';
...
function GLeagueResultsInner({ seasonId, title, initialTab }: Props) {
  const PAGE_SIZE = 6;
...
export default function GLeagueResults({ seasonId, title }: Props) {
  return (
    <GoalWrapper fallback={<GLeagueResultsSkeleton />}>
      <GLeagueResultsInner seasonId={seasonId} title={title} />
    </GoalWrapper>
  );
}
