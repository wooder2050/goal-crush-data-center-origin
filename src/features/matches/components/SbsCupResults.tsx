...
import SbsCupResultsSkeleton from '@/features/matches/components/SbsCupResultsSkeleton';
            ...
            <div>
              ...
              {isFetchingNextPage && (
                <div className="mt-6 flex items-center justify-center">
                  <span
                    className="inline-block h-6 w-6 animate-spin rounded-full border-2 border-gray-300 border-t-red-600"
...
export default function SbsCupResults({ seasonId, title }: Props) {
  return (
    <GoalWrapper fallback={<SbsCupResultsSkeleton />}>
      <SbsCupResultsInner seasonId={seasonId} title={title} />
    </GoalWrapper>
  );
}
