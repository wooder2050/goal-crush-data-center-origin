...
export type PlayerSummaryData = Awaited<
  ReturnType<typeof getPlayerSummaryPrisma>
>;

/**
 * 선수 통산 요약을 Prisma로 직접 집계 (SSR/RSC에서 자체 API HTTP 호출 없이 사용).
 * /api/players/[player_id]/summary 라우트와 동일한 페이로드를 반환한다.
 */
