...
export const metadata: Metadata = {
  title: '골때녀 출연진·선수 명단 - 시즌별 기록·득점·어시스트 총정리',
  description:
    '골 때리는 그녀들 전체 출연진·선수 프로필과 시즌별 득점·어시스트·출전 기록을 한눈에! 팀별·포지션별 검색으로 원하는 멤버를 빠르게 찾아보세요.',
  keywords: [
    '골때녀 선수',
    '골때녀 출연진',
    '골때녀 멤버',
  ...
  twitter: {
    ...
    title: '골때녀 출연진·선수 명단 - 시즌별 기록·득점·어시스트 총정리',
    description:
      '골 때리는 그녀들 전체 출연진·선수 프로필과 시즌별 기록을 한눈에! 팀별·포지션별 검색 가능.',
  },
};
